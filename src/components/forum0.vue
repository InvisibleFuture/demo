...
<div id="forum">
  ...
  <div v-if="layer" id="layer" tabindex="-1" @click="layer_off" @keyup.esc="layer_off" style="position:fixed;
    left:0;
    top:0;
    right:0;
    bottom: 0;
  ...
  <ul>
      <li v-for="r in list">
          <a class="img-wraper" @click.stop="layer_on" :href="'p'+r.id" >
              aaaa
          </a>
      </li>
  </ul>
